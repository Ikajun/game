...
<html>
<head>
    <title>FORM CREDIT</title>
</head>
<body>
    <h1>UPDATE CREDIT</h1>
		<form action="proses_ubah_credit.php?username=<?php echo $_GET['username']; ?>" method="POST">
			<?php
